...
/**	
 * @description Post请求代理工具
 * @author wangpeng
 * @since 2019/7/16 14:41
 */
public class ProxyTools {

    public static void main(String[] args) {
        //HttpsProxy("https://www.baidu.com//", "", "9.1.121.11", 58888);
        HttpProxy("http://9.1.176.206:7001/prpall/index.jsp", "", "9.1.121.11", 58888);
    }
